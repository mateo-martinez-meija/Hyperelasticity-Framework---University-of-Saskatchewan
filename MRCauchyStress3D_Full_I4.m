...
function CauchyStress = MRCauchyStress3D_Full_I4(theta,s,c,model,N,M)
...
for i=1:length(theta)
    ...
    switch model
        ...
        case 'Exp'
            S_ = S_ +...
                ExpSEDFder_I4(n,c4,C_)*psi(i)*transpose(n)*n;

        case 'HS1'
            S_ = S_ +...
                HS1SEDFder_I4(n,c4,C_)*psi(i)*transpose(n)*n;

        case 'HS2'
            S_ = S_ +...
                HS2SEDFder_I4(n,c4,C_)*psi(i)*transpose(n)*n;

        case 'Cust'
            S_ = S_ +...
                CustSEDFder_I4(n,c4,C_)*psi(i)*transpose(n)*n;
