...
function CauchyStress = MRCauchyStress3D_Full_I4_Perp(theta,s,c,model,N)

a = c(1);
b = c(2);
c4 = c(3:end); % Coefficients for I4
lambda = (1 + s/100)^2; % We calculate the stretch ratio square
...
CauchyStress = sigma(1,1)/lambda; % Calculate the nominal stress
end
